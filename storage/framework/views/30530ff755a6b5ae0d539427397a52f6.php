<!-- BEGIN: Header-->
<script>
    const waiterId = "<?php echo e($userwaiter->id); ?>";
</script>
    ...
    <div class="navbar-wrapper">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mobile-menu d-md-none mr-auto pb-3"><a class="nav-link nav-menu-main menu-toggle hidden-xs" href="<?php echo e(url('waiter/dashboard')); ?>"><i class="feather icon-menu font-large-1"></i></a></li>
                <li class="nav-item pb-3 move-up-li"><a class="navbar-brand" href="<?php echo e(url('waiter/dashboard')); ?>"><img class="brand-logo" style="width: 40px" alt="stack admin logo" src="<?php echo e(url('shops/' .  $userwaiter->shop->logo)); ?>">
            ...
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon feather icon-bell"></i><span id="orderCountt"  class="badge badge-pill badge-danger badge-up"></span></a>
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            ...
                            <audio id="notificationSound">
                                <source src="<?php echo e(url('sound/notifaction.mp3')); ?>" type="audio/mpeg">
                    ...
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <div class="avatar avatar-online"><img src="<?php echo e(url('shops/' .  $userwaiter->shop->logo)); ?>" alt="avatar"><i></i></div><span class="user-name"><?php echo e(auth()->user()->name); ?></span>
                        </a>
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="<?php echo e(route('shop.edit', $userShop->id)); ?>">
                                Profile
...
<!-- END: Header-->
<?php /**PATH /home/jcwbgkteayia/public_html/Menu/resources/views/dashboard/waiterinclude/header.blade.php ENDPATH**/ ?>