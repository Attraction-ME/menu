                    ...
                    <div class="noresult-screen-details-full">
                        <ul class="nav nav-pills mb-3" id="no-result-tab" role="tablist">
                            ...
                            <?php $__currentLoopData = $shop->categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link custom-home1-tab-btn category" id="mc-submit" value="<?php echo e($category->id); ?>"  type="button" role="tab"  aria-selected="false"><?php echo e($category->name); ?></button>
                                        ...
                                        <div id="products" class="wishlist-wrapper-full">
                                            ...
                                            <?php $__currentLoopData = $shop->product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div style="background-color: #343537 !important;" class="shoes-screen-wrapper">
                                                        ...
                                                        <div class="shoes-screen-bottom-full">
                                                            ...
                                                            <div style="padding: 8px !important;" class="shoes-screen-second">
                                                                <div class="cloth-txt1">
                                                                    <span><?php echo e($product->finalprice); ?> <?php echo e($shop->currency->name); ?></span>
                                                                </div>
                                                                <div class="shoes-screen-second-full">
                                                                    <button type="button" data-product-id="<?php echo e($product->id); ?>" style="background-color: red !important;"  class="border-0 center align-content-center text-center add_cart " >
                                                    ...
                                                    <!-- Modal -->
                                                    <div class="modal fade" style="top: 3% !important;" id="staticBackdrop<?php echo e($product->id); ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                                                ...
                                                                                <div class="container">
                                                                                    <div class="cloths-second-sec-full">
                                                                                        <div class="cloths-second-wrapper">
                                                                                            <h1 class="clo-txt1"><?php echo e($product->name); ?></h1>
                                                                                    ...
                                                                                    <div class="clothes-sixth-wrap">
                                                                                        <div class="clothes-sixth-full">
                                                                                            <div class="cloth-price-sec">
                                                                                                ...
                                                                                                <span class="price-sec2"><?php echo e($product->finalprice); ?> <?php echo e($shop->currency->name); ?></span>
                                                                                            </div>
													...
													<svg width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
														...
														<path d="M4 7V1" stroke="#707070" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                                                                        ...
                                                                                        <div class="add-to-cart-cloth-btn text-center ">
                                                                                            <button class="th-btn add_cart w-100" data-product-id="<?php echo e($product->id); ?>" type="button" >Add To Cart</button>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
    ...
    <div class="bottom-tabbar">
        <div class="bottom-tabbar-full">
            <nav>
                ...
                <a class="active"  data-bs-toggle="modal" data-bs-target="#staticBackdrop2">
                    ...
                    <span class="" id="subtotal"><?php echo e($total); ?> <?php echo e($shop->currency->name); ?></span>
                </a>
                <div style="font-size: 10px !important;" class="text-white text-center">COPYRIGHT © 2024 BY ATTRACTIONME. All Rights Reserved</div>


                <div class="modal fade" style="top: 15% !important;height: 600px !important;" id="staticBackdrop2" data-bs-backdrop="fixed" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                                                        ...
                                                        <div class="cart-without-promocode-first-full">
                                                            ...
                                                            <div class="cart-without-content-sec">
                                                                <div class="cart-without-content-sec-full">
                                                                    ...
                                                                    <p class="price-code-txt1"><?php echo e($details['name']); ?></p>
                                                                    <p class="price-code-txt2"> <?php echo e($details['quantity']); ?> × <?php echo e($details['price']); ?> <?php echo e($shop->currency->name); ?>  </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="without-code-last mt-24">
                                            <div class="without-code-last-full">
                                                <div>
                                                    ...
                                                    <p id="subtotal2" class="price-txt"><?php echo e($total); ?> <?php echo e($shop->currency->name); ?></p>
                                                </div>
                                                <div class="proceed-to check-btn">
                                                    <a class="w-100" href="<?php echo e(route('cart')); ?>">View Cart</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        if (res.products.length <= 0) {
            ...
            for (let i = 0; i < res.products.length; i++) {
                ...
                htmlView += `
                                         <div style="background-color: #343537 !important;" class="shoes-screen-wrapper">
                                                    ...
                                                    <div class="shoes-screen-bottom">
                                                        <div class="shoes-screen-bottom-full">
                                                            ...
                                                            <div style="padding: 8px !important;" class="shoes-screen-second">
                                                                <div class="cloth-txt1">
                                                                    <span>${res.products[i].finalprice}<?php echo e($shop->currency->name); ?></span>
                                                                </div>
                                                                <div class="shoes-screen-second-full">
                        ...
                        <div class="cloth-price-sec">
                        <span class="price-sec1">Price:</span>
                        <span class="price-sec2">${res.products[i].finalprice}<?php echo e($shop->currency->name); ?></span>
                        </div>
                        <div class="cloths-increment-sec">
                        <div class="product-incre">
                                                        ...
                                                        <div class="cart-without-promocode-first-full">
                                                            ...
                                                            <div class="cart-without-content-sec">
                                                                <div class="cart-without-content-sec-full">
                                                                    ...
                                                                    <p class="price-code-txt2"> ${order.quantity} × ${order.price} <?php echo e($shop->currency->name); ?>  </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="cart-boder mt-16"></div>
...
$.ajax({
    ...
    success: function (response) {
        ...
        $('#subtotal2').text( response.subtotal +' '+ ' <?php echo e($shop->currency->name); ?>');
