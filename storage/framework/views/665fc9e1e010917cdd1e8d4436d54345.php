                        ...
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    ...
                                    <?php endif; ?>
                                    <form class="form" action="<?php echo e(route('products.update', $product->id)); ?>"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" value="<?php echo e($product->name); ?>" id="userinput1"
                                                ...
                                                <div class="col-md-6">
                                                    <h4 class="form-section text-dark"><i class="feather icon-edit-2"></i>
                                                        Product Price</h4>
                                                    <div class="form-group">
                                                        <input type="text"  value="<?php echo e($product->price); ?>" id="price"
                                                ...
                                                <div class="col-md-6">
                                                    <h4 class="form-section text-dark"><i class="feather icon-edit-2"></i>
                                                        Product Sale</h4>
                                                    <div class="form-group">
                                                        <input type="text"  value="<?php echo e($product->sale); ?>" id="price"
                                                ...
                                                <div class="col-md-12">
                                                    <h4 class="form-section text-dark"><i class="feather icon-edit-2"></i>
                                                        Product Detalis</h4>
                                                    <div class="form-group">
                                                        <textarea type="text" id="productdetails" class="form-control border-primary" name="details" rows="5"><?php echo e($product->details); ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
...
<?php echo $__env->make('dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/jcwbgkteayia/public_html/Menu/resources/views/dashboard/products/edit.blade.php ENDPATH**/ ?>