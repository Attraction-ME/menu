...
<head>
    ...
    <link rel="apple-touch-icon" href="<?php echo e(url('dashboard/app-assets/images/ico/apple-icon-120.png')); ?>">
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(url('dashboard/app-assets/images/logo/logo.png')); ?>">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('dashboard/app-assets/vendors/css/pickers/pickadate/pickadate.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('dashboard/app-assets/vendors/css/forms/toggle/switchery.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('dashboard/app-assets/css/pages/app-invoice.css')); ?>">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('dashboard/app-assets/css/pages/app-invoice.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('dashboard/app-assets/vendors/css/forms/selects/select2.min.css')); ?>">
