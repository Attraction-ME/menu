    ...
    <div class="navbar-wrapper">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item pb-3 move-up-li"><a class="navbar-brand" href="<?php echo e(url('/manager/dashboard')); ?>"><img class="brand-logo" style="width: 40px" alt="stack admin logo" src="<?php echo e(url('public/dashboard/app-assets/images/logo/logo.png')); ?>">
            ...
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <div class="avatar avatar-online"><img  src="<?php echo e(url('public/dashboard/app-assets/images/logo/logo.png')); ?>" alt="avatar"><i></i></div><span class="user-name"><?php echo e(auth()->user()->name); ?></span>
                        </a>
