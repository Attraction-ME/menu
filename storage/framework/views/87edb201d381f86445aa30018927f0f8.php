...
<div class="site-content">
    ...
    <header id="top-navbar" class="top-navbar">
        <div class="container">
            <div class="top-navbar_full">
                ...
                <div class="top-navbar-title">
                   <p class="m-0">Hello,Table #<?php echo e($table->name); ?></p>
                   <p style="color:yellow;font-size:14px" class="m-0">Waiter:<?php echo e($selectWaiter->name); ?></p>
                </div>
    ...
    <!-- Header End -->
<?php /**PATH /home/mhxh44ujg805/public_html/resources/views/website/includes/header.blade.php ENDPATH**/ ?>