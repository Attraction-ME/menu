...
<head>
    ...
    <meta content="ordarme" name="description" />
    <meta content="" name="keywords" />
    <meta content="" name="author" />

    <!--[if lt IE 9]>
    <script src="{{url('public/website/owner/js/html5shiv.js')}}"></script>
    <![endif]-->

    <!-- CSS Files
================================================== -->
    <link id="bootstrap" href="{{url('public/website/owner/css/bootstrap.min.css')}}" rel="stylesheet" type="text/css" />
    <link id="bootstrap-grid" href="{{url('public/website/owner/css/bootstrap-grid.min.css')}}" rel="stylesheet" type="text/css" />
    <link id="bootstrap-reboot" href="{{url('public/website/owner/css/bootstrap-reboot.min.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{url('public/website/owner/css/animate.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{url('public/website/owner/css/owl.carousel.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{url('public/website/owner/css/owl.theme.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{url('public/website/owner/css/owl.transitions.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{url('public/website/owner/css/magnific-popup.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{url('public/website/owner/css/jquery.countdown.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{url('public/website/owner/css/style.css')}}" rel="stylesheet" type="text/css" />

    <!-- color scheme -->
    <link id="colors" href="{{url('public/website/owner/css/colors/scheme-01.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{url('public/website/owner/css/coloring.css')}}" rel="stylesheet" type="text/css" />
...
<div id="wrapper">
                ...
                <div class="col-md-12">
                    <div class="de-flex sm-pt10">
                        <div class="de-flex-col">
                            ...
                            <div id="logo">
                                <a href="index.html">
                                    <img alt="" class="logo" src="{{url('public/website/owner//images/logo-light.png')}}" />
                                    <img alt="" class="logo-2" src="{{url('public/website/owner//images/logo.png')}}" />
                                </a>
                            </div>
                            <!-- logo close -->
                        </div>
    ...
    <div class="no-bottom no-top" id="content">
        ...
        <section aria-label="section" data-bgimage="url({{url('public/website/owner//images/background/1.jpg')}}) top" class="text-light">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 offset-lg-1 text-center wow fadeInLeft" data-wow-delay=".5s">
                        <img src="{{url('public/website/owner//images/misc/1.png')}}" class="img-fluid" alt="" />
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 d-none d-lg-block d-xl-block text-center wow fadeInRight" data-wow-delay="0s">
                        <img class="relative img-fluid" src="{{url('public/website/owner//images/misc/5.png')}}" alt="" />
                    </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        ...
                        <a href="download.html"><img src="{{url('public/website/owner//images/misc/download-appstore.png')}}" class="img-fluid" alt="download"></a>&nbsp;
                        <a href="download.html"><img src="{{url('public/website/owner//images/misc/download-playstore.png')}}" class="img-fluid" alt="download"></a>
                    </div>

                    <div class="col-md-6 text-center">
                        <img src="{{url('public/website/owner//images/misc/2.png')}}" class="img-fluid" alt="">
                    </div>
                </div>
            </div>
        </section>
    ...
    <footer class="footer-light">
        <div class="container">
            <div class="row">
                <div class="col-lg-2">
                    <div class="widget">
                        <a href="index.html"><img alt="" class="logo" src="{{url('public/website/owner//images/logo.png')}}"></a>
                    </div>
                </div>
...
<!-- Javascript Files
================================================== -->
<script src="{{url('public/website/owner/js/jquery.min.js')}}"></script>
<script src="{{url('public/website/owner/js/popper.min.js')}}"></script>
<script src="{{url('public/website/owner/js/bootstrap.min.js')}}"></script>
<script src="{{url('public/website/owner/js/wow.min.js')}}"></script>
<script src="{{url('public/website/owner/js/jquery.isotope.min.js')}}"></script>
<script src="{{url('public/website/owner/js/easing.js')}}"></script>
<script src="{{url('public/website/owner/js/owl.carousel.js')}}"></script>
<script src="{{url('public/website/owner/js/validation.js')}}"></script>
<script src="{{url('public/website/owner/js/jquery.magnific-popup.min.js')}}"></script>
<script src="{{url('public/website/owner/js/enquire.min.js')}}"></script>
<script src="{{url('public/website/owner/js/jquery.stellar.min.js')}}"></script>
<script src="{{url('public/website/owner/js/jquery.plugin.js')}}"></script>
<script src="{{url('public/website/owner/js/typed.js')}}"></script>
<script src="{{url('public/website/owner/js/jquery.countTo.js')}}"></script>
<script src="{{url('public/website/owner/js/jquery.countdown.js')}}"></script>
<script src="{{url('public/website/owner/js/typed.js')}}"></script>
<script src="{{url('public/website/owner/js/designesia.js')}}"></script>
