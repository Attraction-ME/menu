...
<head>
    ...
    <!-- CSS Files
================================================== -->
    <link id="bootstrap" href="{{url('website/owner/css/bootstrap.min.css')}}" rel="stylesheet" type="text/css" />
    <link id="bootstrap-grid" href="{{url('website/owner/css/bootstrap-grid.min.css')}}" rel="stylesheet" type="text/css" />
    <link id="bootstrap-reboot" href="{{url('website/owner/css/bootstrap-reboot.min.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{url('website/owner/css/animate.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{url('website/owner/css/owl.carousel.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{url('website/owner/css/owl.theme.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{url('website/owner/css/owl.transitions.css')}}" rel="stylesheet" type="text/css" />
    ...
    <link href="{{url('website/owner/css/coloring.css')}}" rel="stylesheet" type="text/css" />
...
<!-- Javascript Files
================================================== -->
<script src="{{url('website/owner/js/jquery.min.js')}}"></script>
<script src="{{url('website/owner/js/popper.min.js')}}"></script>
<script src="{{url('website/owner/js/bootstrap.min.js')}}"></script>
<script src="{{url('website/owner/js/wow.min.js')}}"></script>
<script src="{{url('website/owner/js/jquery.isotope.min.js')}}"></script>
<script src="{{url('website/owner/js/easing.js')}}"></script>
<script src="{{url('website/owner/js/owl.carousel.js')}}"></script>
<script src="{{url('website/owner/js/validation.js')}}"></script>
<script src="{{url('website/owner/js/jquery.magnific-popup.min.js')}}"></script>
<script src="{{url('website/owner/js/enquire.min.js')}}"></script>
<script src="{{url('website/owner/js/jquery.stellar.min.js')}}"></script>
<script src="{{url('website/owner/js/jquery.plugin.js')}}"></script>
<script src="{{url('website/owner/js/typed.js')}}"></script>
<script src="{{url('website/owner/js/jquery.countTo.js')}}"></script>
<script src="{{url('website/owner/js/jquery.countdown.js')}}"></script>
<script src="{{url('website/owner/js/typed.js')}}"></script>
<script src="{{url('website/owner/js/designesia.js')}}"></script>
