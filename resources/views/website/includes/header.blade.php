        ...
        <div class="container">
            <div class="top-navbar_full">
                ...
                <div class="top-navbar-title">
                    <a href="{{ route('website.welcome',$shop->slug) }}">
                        <img style="height: 56px !important;" src="{{ url('public/shops/' . $shop->logo) }}" alt="Pizzan">
                    </a>
                </div>
                <div class="top-navbar-title">
                   <p class="m-0">Hello,Table #{{$table->name}}</p>
                   <p style="color:yellow;font-size:14px" class="m-0">Waiter:{{$selectWaiter->name}}</p>
                </div>
