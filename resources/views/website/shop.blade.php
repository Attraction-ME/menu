    ...
    <section id="noresult-screen">
            ...
            <div class="noresult-screen-full">
                <form action="#" method="POST" class="search-form w-100">
                    ...
                    <div class="input-group search-page-searchbar ">
                        <button style="    height: 30px;border-radius: 0;" class="input-group-text search-iconn" id="products-search-icon">
        ...
        <div class="noresult-screen-details">
            <div class="noresult-screen-details">
                <div class="noresult-screen-details-bottom ">
                    <div class="noresult-screen-details-full">
                        <ul class="nav nav-pills mb-3 d-flex flex-wrap align-items-center justify-content-center"
                            id="no-result-tab" role="tablist" style="flex-wrap: wrap !important;">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active custom-home1-tab-btn category m-2" id="mc-submit"
                                    value="all" type="button" role="tab" aria-selected="true">All Meals</button>
                            </li>
                            @foreach ($shop->categories as $category)
                                <li class="nav-item m-2" role="presentation">
                                    <button class="nav-link custom-home1-tab-btn category" id="mc-submit"
                                        value="{{ $category->id }}" type="button" role="tab"
                                        aria-selected="false">{{ $category->name }}</button>
                                    <input type="hidden" id="shopId" class="form-control" name="shop_id"
                                        value="{{ $shop->id }}">
                                </li>
                            @endforeach
                                                ...
                                                <div style="background-color: #343537 !important;"
                                                    ...
                                                    <div class="shoes-screen-top">
                                                        <div class="shoes-img wishlist-img">
                                                            <a type="button" href="#" class="border-0"
                                                    ...
                                                    <div class="shoes-screen-bottom">
                                                        <div class="shoes-screen-bottom-full">
                                                            ...
                                                            <div style="padding: 8px !important;"
                                                                class="shoes-screen-second">
                                                                <div class="cloth-txt1">
                                                                    @if (!$product->hasMainOptions)
                                                                ...
                                                                <div class="shoes-screen-second-full">
                                                                    ...
                                                                    @else
                                                                        <button type="button" data-bs-toggle="modal"
                                                                            ...
                                                                            class="border-0 center align-content-center text-center ">
                                                                            <i class="fa fa-plus"
                                                                                style="color: white !important;"></i>
                                                                        </button>
                                                                    @endif
                                                    ...
                                                    <!-- Modal -->
                                                    <div class="modal fade" style="top: 3% !important;"
                                                                        ...
                                                                        <div class="single-clothes-page-full">
                                                                            <div class="cloths-first-sec">
                                                                                <div id="carouselExampleIndicators"
                                                                                    class="carousel slide single-clothes-slider"
                                                                                    ...
                                                                                    <div class="carousel-inner">
                                                                                        @foreach ($product->images as $image)
                                                                                            <div
                                                                                                ...
                                                                                                <div
                                                                                                    class="single-clothes-slide-img">
                                                                                                    <img style="height: 200px !important;"
                                                                                                        src="{{ url('products/' . $image->name) }}"
                                                                                                        alt="img">
                                                                                                </div>
                                                                                    ...
                                                                                    <button
                                                                                        class="carousel-control-prev single-slider-btn-prev"
                                                                                        type="button"
                                                                                    ...
                                                                                    <button
                                                                                        class="carousel-control-next single-slider-btn-next"
                                                                                        type="button"
                                                                                        data-bs-target="#carouselExampleIndicators"
                                                                                        data-bs-slide="next">
                                                                                        <span>
                                                                            ...
                                                                            @if ( $product->hasMainOptions )
                                                                                <div class="cloth-third-sec">
                                                                                    <div class="container">
                                                                                        <h2 class="d-none"> Main Options </h2>
                                                                                        <div class="cloth-third-sec-full">
                                                                                            <h3 class="des-txt1"> Main Options
                                                                                            </h3>
                                                                            ...
                                                                            <div class="cloth-third-sec">
                                                                                <div class="container">
                                                                                    <div class="clothes-sixth-wrap">
                                                                                        ...
                                                                                        <div
                                                                                            class="add-to-cart-cloth-btn text-center ">
                                                                                            <button
    ...
    <div class="bottom-tabbar">
        <div class="bottom-tabbar-full">
            <nav>
                ...
                <div style="font-size: 10px !important;" class="text-white text-center">COPYRIGHT © 2024 BY ATTRACTIONME.
                    All Rights Reserved</div>

                <div class="modal fade" style="top: 15% !important;height: 600px !important;" id="staticBackdrop02"
                    data-bs-backdrop="fixed" data-bs-keyboard="false" tabindex="-1"
                    aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                                                        ...
                                                        <div class="cart-without-promocode-first-full">
                                                            <div>
                                                                <div class="cart-without-img-sec">
                                                                    <img src="{{ url('products/' . $details['image']) }}"
                                                                        alt="">
                                                                </div>
                                                            </div>
                                                            <div class="cart-without-content-sec">
                                                                <div class="cart-without-content-sec-full">
                                                                    <a data-id="{{ $id }}" href="#"
                                                                        class="remove remove_from_cart_button remove-from-cart"><i
                                                                            class="far fa-times"></i></a>
                                                                    <p class="price-code-txt1">{{ $details['name'] }}</p>
                                                                    <p class="price-code-txt2"> {{ $details['quantity'] }}
                                                                        × {{ $details['price'] }}
                                                                        {{ $shop->currency->name }} </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="without-code-last mt-24">
                                            <div class="without-code-last-full">
                                                <div>
                                                    ...
                                                    <p id="subtotal2" class="price-txt">{{ $total }}
                                                        {{ $shop->currency->name }}</p>
                                                </div>
...
@section('scripts')
    ...
    <script>
        ...
        // calculate price in main product modal
                ...
                $.ajax({
                                ...
                                $("#noticart").append(`
                                    <div class="cart-without-promocode-first">
                                        <div class="cart-without-promocode-first-full">
                                            ...
                                            <div class="cart-without-content-sec">
                                                <div class="cart-without-content-sec-full">
                                                    <a data-id="${productId}" href="#" class="remove remove_from_cart_button remove-from-cart"><i
                                                            class="far fa-times"></i></a>
                    ...
                    error: function(error) {
                        alert(error.responseJSON
                            .error); // or display an error message in your UI
                    }
                });
            });
