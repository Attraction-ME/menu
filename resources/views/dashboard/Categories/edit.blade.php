                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    ...
                                    <form class="form" action="{{ route('categories.update', $category->id) }}" method="post" enctype="multipart/form-data">
                                        ...
                                        @method('put')
                                        <div class="form-body">
                                            <h4 class="form-section"><i class="feather icon-edit-2"></i> Category Name</h4>

                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <input type="text" id="userinput1" class="form-control border-primary" value="{{$category->name}}"  placeholder="name" name="name">
                                                    </div>
                                                </div>
                                            </div>
                                            <h4 class="form-section"><i class="fa fa-photo"></i> Category Image  </h4>
