                        ...
                        <div class="card">
                                ...
                                <div class="card-header">
                                    <div class="row align-items-center">
                                        <div
                                            ...
                                            <img src="{{ url('shops/' . $order->shop_order->logo) }}" alt="logo"
                                                height="46" width="164">
                                        </div>
                                        <div
                                            ...
                                            <div
                                                ...
                                                <input type="text" class="form-control"
                                                    value="{{ date_format($order->created_at, 'm/d/Y, g:i A') }}"readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-12 col-xl-12 col-xs-12 col-sm-12">
                                        ...
                                        <div class="row d-flex">
                                            ...
                                            <div class="col-10 col-md-5 mb-2">
                                                <input type="text" class="form-control" value="{{ $order->table->name }}"
                                                    readonly>
                                                ...
                                                <div class="d-flex flex-wrap">
                                                    <div class=" col-md-4 col-sm-12 mb-2">
                                                        ...
                                                        <select name="product_id[]" class="select2 form-control class">
                                                            <option value="{{ $order_detail->order_product->id }}" selected>
                                                                {{ $order_detail->order_product->name }}</option>
                                                    ...
                                                    <div class=" col-md-2 col-sm-3 mb-1">
                                                        <label>Amount</label>
                                                        <input class="form-control quantityy" type="number"
                                                            name="quantity[]" value="{{ $order_detail->quantity }}">
                                                    </div>
                                                    <div class=" col-md-2 col-sm-3 mb-1">
                                                        <label>Price</label>
                                                        <input type="number" id=""
                                                            class="form-control request_price" name="price[]"
                            ...
                            <div class="d-flex flex-wrap">
                                <div class="col-12 col-md-4 mb-2">
                                    <label>SubTotal</label>
                                    <input id="" type="number" class="form-control ordertotal" name="ordertotal"
                                ...
                                <div class="col-12 col-md-4 mb-2">
                                    <label>Total</label>
                                    <input id="" type="number" class="form-control total" name="total"
                                        value="{{ $order->total }}" readonly>
                                </div>
...
`);
                ...
                $('.class').on('change', function() {
                    ...
                    $.ajax({
                        url: "{{ url('get-price') }}", // Change this to the URL you want to use
                        type: "POST",
                        data: {
                        ...
                        success: function(result) {
                            ...
                            var quan = parseFloat($(this).closest('.d-flex').find(
                                '.quantityy').val());
                            var price = parseFloat($(this).closest('.d-flex').find(
                                '.request_price').val());
                            parseFloat($(this).closest('.d-flex').find('.subtotal').val(
                                quan * price));
                            //get total
                    ...
                    $(".quantityy").on('change', function() {
                        ...
                        var price = parseFloat($(this).closest('.d-flex').find(
                            '.request_price').val());
                        parseFloat($(this).closest('.d-flex').find('.subtotal').val(quan *
                            price));
                        //get total
                        var temp = 0;
                        $(".subtotal").each(function() {
            ...
            $('.class').on('change', function() {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        var quan = parseFloat($(this).closest('.d-flex').find('.quantityy')
                        .val());
                        var price = parseFloat($(this).closest('.d-flex').find('.request_price')
                            .val());
                        var disc = $(".discount").val();
